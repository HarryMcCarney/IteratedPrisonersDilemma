...
let runExperiment startingPlayers generations (results: GenerationResult array) = 
    ...
    go startingPlayers generations 0 results
...
runExperiment players 1 [|initResults|]
|> fun results -> 
    players
